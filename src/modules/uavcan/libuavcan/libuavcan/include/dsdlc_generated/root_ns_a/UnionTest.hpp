 ...
 *
 * Source file: /home/zisemangguo/workspace/Firmware/src/modules/uavcan/libuavcan/libuavcan/test/dsdl_test/root_ns_a/UnionTest.uavcan
 */
...
{
    return is(UnionTest_<0>::Tag::z) ? &z : NULL;
}
...
{
    return is(UnionTest_<0>::Tag::a) ? &a : NULL;
}
...
{
    return is(UnionTest_<0>::Tag::b) ? &b : NULL;
}
...
{
    return is(UnionTest_<0>::Tag::c) ? &c : NULL;
}
...
{
    return is(UnionTest_<0>::Tag::d) ? &d : NULL;
}
...
{
    return is(UnionTest_<0>::Tag::e) ? &e : NULL;
}
